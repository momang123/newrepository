 ...
 <div class="row">
	...
	<div class="col-md-6">
		<div class="card card-signin flex-row my-5">
			<div class="card-body">
				...
				<h1 class="card-title text-center"> Form Pesanan  Desain</h1>

				<input  type="hidden" name="user" value="<?php echo $_SESSION['username'] ?>">
                <input  type="hidden" name="desain" value="<?php echo $data['kode_desain']; ?>">
    ...
    <div class="col-md-6">
		<div class="card card-signin flex-row my-5">
			...
			<input type="text" placeholder="No Rekening"  class="form-control"  name="no_rek"  required autofocus>
			</div>
			...
			<div class="form-label-group">
                    ...
                    <div class="form-label-group">
						...
						<input type="text" placeholder="Jumlah"  class="form-control" onchange="kali()"  name="jumlah"  required autofocus>
					</div>
...
<p> DP sebesar 30% dicicil selama 3 bulan. Untuk harga rumah di atas 500 juta terminnya 3x bayar, sedangkan harga di bawah 500 juta terminnya 2x bayar</p>
    ...
    <?php
			if (isset($_POST["btnsimpan"])) {
					$desain = mysqli_real_escape_string($konek, $_POST['desain']);
					...
					if ($cek_user > 0) {
						...
						$simpan = mysqli_query($konek,"INSERT INTO tbl_pesanan(kode_desain,user_name_pelanggan,nama,no_rek,bank,total_bayar,jumlah,metode,tanggal) VALUES ('$desain','$user','$nama','$rekening','$bank','$total','$jumlah','$metode','$tanggal')");
						if ($simpan) {
							?>
